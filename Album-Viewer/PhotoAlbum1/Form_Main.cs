...
namespace PhotoAlbumViewOfTheGods
{
    ...
    public partial class Form_Main : Form
    {
        ...
        {
            oldPanelLeftWidth = this.panelLeft.Width;
        ...
        {
            buttonHideTree.ForeColor = Color.Black;
            buttonHideTree.BackColor = Color.WhiteSmoke;
        }
        ...
        private void buttonHideTree_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.panelLeft.Width = oldPanelLeftWidth;
                treeView_Albums.Visible = true;
